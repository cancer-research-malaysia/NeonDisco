...
LABEL version="1.0"
LABEL description="container image of tools for Alt splicing grapher MAJIQ v2.5"
...
build-essential tar wget curl pigz gzip zip unzip gcc g++ bzip2 procps git cmake locales coreutils gawk grep sed nano libhts-dev zlib1g-dev \
...
COPY --chown=$MAMBA_USER:$MAMBA_USER majiq/context/base_env.yaml /tmp/base_env.yaml
