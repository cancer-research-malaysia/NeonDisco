...
LABEL version="1.0"
LABEL description="minimal container image for SnpEff and SnpSift for CRMY"
...
COPY --chown=$MAMBA_USER:$MAMBA_USER snpeff/context/base_env.yaml /tmp/base_env.yaml
