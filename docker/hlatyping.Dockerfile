...
LABEL version="1.0"
LABEL description="container image of HLA-HD program v1.7.1 (Oct 2024) + arcasHLA v0.6.0"
...
COPY --chown=$MAMBA_USER:$MAMBA_USER hlatyping/context/base_env.yaml /tmp/base_env.yaml
