...
LABEL version="1.0"
LABEL description="minimal container image for Reditools1 for CRMY - revision removed MatchHostFsOwner"
...
# install REDItools1
RUN git clone https://github.com/BioinfoUNIBA/REDItools && cd REDItools && python setup.py install
