...
RUN pip install lxml && pip install git+https://github.com/frankligy/SNAF.git@e23ce39512a1a7f58c74e59b4b7cedc89248b908

# add conda bins to PATH
ENV PATH="/opt/conda/bin:/opt/conda/condabin:$PATH"

# add hla.dat file to the container
COPY --chown=$MAMBA_USER:$MAMBA_USER snaf/src/download.tar.gz /usr/src/SNAF-download.meta.tar.gz
