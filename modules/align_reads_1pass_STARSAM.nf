...
process ALIGN_READS_1PASS_STARSAM {
    ...
    stub:
    """
    touch ${sampleName}-STAR_1pass_Aligned.out.bam
    touch ${sampleName}-STAR_1pass_Log.final.out
    touch ${sampleName}-STAR_1pass_SJ.out.tab
    echo "Stub run finished!" > test_stub_STAR-1pass-align.log
    """
}
