...
process CALL_FUSIONS_FUSIONCATCHER {
    ...
    containerOptions "--rm -e \"MHF_HOST_UID=\$(id -u)\" -e \"MHF_HOST_GID=\$(id -g)\" --name FT-CALLING-FUSCAT -v ${params.fuscatDB}:/home/app/libs -v \$(pwd):/home/app/nf_work -v ${params.binDir}:/home/app/scripts"
