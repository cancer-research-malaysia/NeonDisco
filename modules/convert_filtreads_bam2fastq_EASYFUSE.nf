...
process CONVERT_FILTREADS_BAM2FASTQ_EASYFUSE {
    ...
    samtools fastq -0 "\${SAMPLE_ID}-filtered.other.fastq.gz" -1 "\${SAMPLE_ID}-filtered.read1.fastq.gz" -2 "\${SAMPLE_ID}-filtered.read2.fastq.gz" --threads ${params.numCores} \${BAM}
