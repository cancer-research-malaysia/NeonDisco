...
process ALIGN_READS_TWOPASS_STARSAM {
    ...
    afterScript params.cleanupIntermediates ? "find ./ -name '${sampleName}_trimmed.f*q.*' -type l -exec sh -c 'rm -f \$(readlink -f \"{}\")' \\; -delete" : "echo 'Skipping intermediate file cleanup...'"
