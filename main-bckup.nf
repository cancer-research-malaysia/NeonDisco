...
Required Arguments:
---------------
    -profile            Either <s3local> for local runs with remote S3 files, or <awsbatch> for AWS Batch [MANDATORY]
...
---------------
    ...
    --trimReads          Set to <true> to perform read trimming on FASTQ input [DEFAULT: false]
